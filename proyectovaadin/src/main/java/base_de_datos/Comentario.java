...
public class Comentario implements Serializable {
    ...
    @OneToMany(mappedBy = "pertenecea_comentario", targetEntity = base_de_datos.Documento.class, fetch = FetchType.EAGER)
    ...
    @org.hibernate.annotations.Cascade({org.hibernate.annotations.CascadeType.SAVE_UPDATE, org.hibernate.annotations.CascadeType.LOCK})
    @JoinTable(name = "Usuario_Comentario",
               joinColumns = { @JoinColumn(name = "ComentarioIdComentario") },
    ...
    @Transient
    public final base_de_datos.DocumentoSetCollection comentario_contiene = new base_de_datos.DocumentoSetCollection(
        this, _ormAdapter,
        base_de_datos.ORMConstants.KEY_COMENTARIO_COMENTARIO_CONTIENE,
        base_de_datos.ORMConstants.KEY_DOCUMENTO_PERTENECEA_COMENTARIO,
    ...
    @Transient
    public final base_de_datos.UsuarioSetCollection comlikeado_por = new base_de_datos.UsuarioSetCollection(
        this, _ormAdapter,
