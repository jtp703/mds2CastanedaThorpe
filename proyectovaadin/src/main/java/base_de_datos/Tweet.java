...
public class Tweet implements Serializable {
    ...
    @ManyToOne(targetEntity = base_de_datos.Tweet.class, fetch = FetchType.EAGER)
    ...
    @ManyToOne(targetEntity = base_de_datos.Usuario.class, fetch = FetchType.EAGER)
    @org.hibernate.annotations.Cascade({org.hibernate.annotations.CascadeType.LOCK})
    ...
    @ManyToMany(targetEntity = base_de_datos.Hashtag.class, fetch = FetchType.EAGER)
    @org.hibernate.annotations.Cascade({org.hibernate.annotations.CascadeType.SAVE_UPDATE, org.hibernate.annotations.CascadeType.LOCK})
    @JoinTable(name = "Hashtag_Tweet",
               joinColumns = {@JoinColumn(name = "TweetIdTweet")},
               inverseJoinColumns = {@JoinColumn(name = "HashtagIdHashtag")})
    private java.util.Set ORM_contiene = new java.util.HashSet();

    @OneToMany(mappedBy = "tweet", targetEntity = base_de_datos.Tweet.class, fetch = FetchType.EAGER)
    @org.hibernate.annotations.Cascade({org.hibernate.annotations.CascadeType.SAVE_UPDATE, org.hibernate.annotations.CascadeType.LOCK})
    ...
    @org.hibernate.annotations.Cascade({org.hibernate.annotations.CascadeType.SAVE_UPDATE, org.hibernate.annotations.CascadeType.LOCK})
    @JoinTable(name = "Usuario_Tweet",
               joinColumns = {@JoinColumn(name = "TweetIdTweet")},
               inverseJoinColumns = {@JoinColumn(name = "UsuarioUsuarioAutentificadoID")})
    private java.util.Set ORM_reetweteado_por = new java.util.HashSet();

    @ManyToMany(targetEntity = base_de_datos.Usuario.class, fetch = FetchType.EAGER)
    @org.hibernate.annotations.Cascade({org.hibernate.annotations.CascadeType.SAVE_UPDATE, org.hibernate.annotations.CascadeType.LOCK})
    @JoinTable(name = "Usuario_Tweet2",
               joinColumns = {@JoinColumn(name = "TweetIdTweet")},
               inverseJoinColumns = {@JoinColumn(name = "UsuarioUsuarioAutentificadoID")})
    private java.util.Set ORM_likeado_por = new java.util.HashSet();

    @OneToMany(mappedBy = "pertenecea_tweet", targetEntity = base_de_datos.Comentario.class, fetch = FetchType.EAGER)
    @org.hibernate.annotations.Cascade({org.hibernate.annotations.CascadeType.SAVE_UPDATE, org.hibernate.annotations.CascadeType.LOCK})
    private java.util.Set ORM_tiene_comentario = new java.util.HashSet();

    @OneToMany(mappedBy = "pertenecea_tweet", targetEntity = base_de_datos.Documento.class, fetch = FetchType.EAGER)
    @org.hibernate.annotations.Cascade({org.hibernate.annotations.CascadeType.SAVE_UPDATE, org.hibernate.annotations.CascadeType.LOCK})
    ...
    @Transient
    public final base_de_datos.HashtagSetCollection contiene = new base_de_datos.HashtagSetCollection(
            this, _ormAdapter,
            base_de_datos.ORMConstants.KEY_TWEET_CONTIENE,
            base_de_datos.ORMConstants.KEY_HASHTAG_APARECE_EN,
    ...
    @Transient
    public final base_de_datos.TweetSetCollection retweet = new base_de_datos.TweetSetCollection(
            this, _ormAdapter,
            base_de_datos.ORMConstants.KEY_TWEET_RETWEET,
            base_de_datos.ORMConstants.KEY_TWEET_TWEET,
    ...
    @Transient
    public final base_de_datos.UsuarioSetCollection reetweteado_por = new base_de_datos.UsuarioSetCollection(
            this, _ormAdapter,
    ...
    @Transient
    public final base_de_datos.UsuarioSetCollection likeado_por = new base_de_datos.UsuarioSetCollection(
            this, _ormAdapter,
    ...
    @Transient
    public final base_de_datos.ComentarioSetCollection tiene_comentario = new base_de_datos.ComentarioSetCollection(
            this, _ormAdapter,
            base_de_datos.ORMConstants.KEY_TWEET_TIENE_COMENTARIO,
            base_de_datos.ORMConstants.KEY_COMENTARIO_PERTENECEA_TWEET,
            base_de_datos.ORMConstants.KEY_MUL_ONE_TO_MANY);
    ...
    @Transient
    public final base_de_datos.DocumentoSetCollection tweet_contiene = new base_de_datos.DocumentoSetCollection(
            this, _ormAdapter,
            base_de_datos.ORMConstants.KEY_TWEET_TWEET_CONTIENE,
            base_de_datos.ORMConstants.KEY_DOCUMENTO_PERTENECEA_TWEET,
            base_de_datos.ORMConstants.KEY_MUL_ONE_TO_MANY);
