...
public class BD_Administradores {
	...
	/**
	 * Intenta iniciar sesión para un Administrador buscándolo por mail y
	 * contraseña. Devuelve el Administrador coincidente, o null si no existe.
	 */
	...
	/**
	 * Busca un Administrador por su ID (Mail). Devuelve el Administrador
