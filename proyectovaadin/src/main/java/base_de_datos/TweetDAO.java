...
public class TweetDAO {
	public static Tweet loadTweetByORMID(int ID) throws PersistentException {
		try {
			PersistentSession session = base_de_datos.MDS12425PFCastanedaThorpePersistentManager.instance().getSession();
			return loadTweetByORMID(session, ID);
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static Tweet getTweetByORMID(int ID) throws PersistentException {
		try {
			PersistentSession session = base_de_datos.MDS12425PFCastanedaThorpePersistentManager.instance().getSession();
			return getTweetByORMID(session, ID);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Tweet loadTweetByORMID(int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = base_de_datos.MDS12425PFCastanedaThorpePersistentManager.instance().getSession();
			return loadTweetByORMID(session, ID, lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Tweet getTweetByORMID(int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			PersistentSession session = base_de_datos.MDS12425PFCastanedaThorpePersistentManager.instance().getSession();
			return getTweetByORMID(session, ID, lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Tweet loadTweetByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Tweet) session.load(base_de_datos.Tweet.class, Integer.valueOf(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Tweet getTweetByORMID(PersistentSession session, int ID) throws PersistentException {
		try {
			return (Tweet) session.get(base_de_datos.Tweet.class, Integer.valueOf(ID));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Tweet loadTweetByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Tweet) session.load(base_de_datos.Tweet.class, Integer.valueOf(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Tweet getTweetByORMID(PersistentSession session, int ID, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Tweet) session.get(base_de_datos.Tweet.class, Integer.valueOf(ID), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static boolean deleteAndDissociate(base_de_datos.Tweet tweet)throws PersistentException {
		try {
			if (tweet.getRetweet() != null) {
				tweet.getRetweet().setTweet(null);
			}
			
			if (tweet.getTweet_usuario() != null) {
				tweet.getTweet_usuario().publica.remove(tweet);
			}
			
			if (tweet.getEs_eliminado() != null) {
				tweet.getEs_eliminado().administrador_tweet.remove(tweet);
			}
			...
			for(int i = 0; i < lTiene_comentarios.length; i++) {
				lTiene_comentarios[i].setComentario_tweet(null);
			}
			...
			if (tweet.getTweet() != null) {
				tweet.getTweet().setRetweet(null);
			}
