...
public class CreateMDS12425PFCastanedaThorpeData {
	public void createTestData() throws PersistentException {
		...
		try {
			...
			// TODO Initialize the properties of the persistent object here, the following properties must be initialized before saving : likea_comentario, likea, retweetea, publica_comentario, es_seguido, es_bloqueado, tweetea, sigue, bloquea, baneado
			...
			// TODO Initialize the properties of the persistent object here, the following properties must be initialized before saving : tweet_contiene, tiene_comentario, likeado_por, reetweteado_por, contiene, numComentarios, numRetweets, numMegustas, tweeteado_por
			...
			// TODO Initialize the properties of the persistent object here, the following properties must be initialized before saving : comlikeado_por, numMegustas, pertenecea_tweet, comentado_por
