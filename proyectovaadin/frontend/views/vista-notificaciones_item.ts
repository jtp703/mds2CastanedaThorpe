...
<vaadin-vertical-layout style="width: 100%; position:absolute;" id="_layoutNotificacionUsuario">
 <vaadin-vertical-layout theme="spacing" id="_LayoutRetweetUsuario" style="width: 100%; flex-grow: 0;">
 ...
 <vaadin-vertical-layout theme="spacing" style="width: 100%;" id="_LayoutMegustaUsuario">
  <vaadin-horizontal-layout theme="spacing-l" style="align-self: stretch;background-color: #f0f0f0;">
 ...
 <vaadin-vertical-layout theme="spacing" style="width: 100%; justify-content: flex-start;" id="_LayoutSeguimientoUsuario">
  <vaadin-horizontal-layout theme="spacing-l" style="align-self: stretch; background-color: #f0f0f0; align-items: flex-start;">
   <a href="" id="_verPerfilSeguidor" style="flex-grow: 0; align-self: center;">@usuario</a>
   <vaadin-icon style="align-self: center;" icon="vaadin:heart" size="16"></vaadin-icon>
   <label>te ha seguido</label>
  </vaadin-horizontal-layout>
 </vaadin-vertical-layout>
 <vaadin-vertical-layout theme="spacing" style="width: 100%;" id="_LayoutMencionUsuario">
  <vaadin-horizontal-layout theme="spacing-l" style="align-self: stretch;background-color: #f0f0f0;">
