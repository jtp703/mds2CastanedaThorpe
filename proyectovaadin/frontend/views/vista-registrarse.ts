...
<vaadin-vertical-layout style="width: 100%; height: 100%;position:absolute;" id="contenedorRegistrarse">
 <vaadin-horizontal-layout theme="spacing" style="align-self: center; flex-grow: 0; flex-shrink: 0;">
  <vaadin-vertical-layout theme="spacing" style="flex-shrink: 1;">
   ...
   <vaadin-text-field id="nombreCompleto" type="text" label="Nombre"></vaadin-text-field>
