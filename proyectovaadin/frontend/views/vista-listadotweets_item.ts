...
<vaadin-horizontal-layout theme="spacing" style="flex-grow: 0; align-self: center; width: 70%; justify-content: center; align-items: center; position:absolute;" id="contenedorInteracciones">
