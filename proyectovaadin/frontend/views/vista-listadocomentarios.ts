...
<vaadin-vertical-layout theme="spacing" style="width: 100%; height: 100%; position:absolute;" id="vaadinVerticalLayout">
 <vaadin-vertical-layout theme="spacing" id="contenedorListadoTweets" style="flex-shrink: 1; width: 100%;"></vaadin-vertical-layout>
 <vaadin-vertical-layout theme="spacing" style="flex-shrink: 1; width: 100%;" id="contenedorListadoComentariosItem"></vaadin-vertical-layout>
 <vaadin-horizontal-layout theme="spacing" id="contenedorEscribirComentario" style="width: 75%; height: 100%; align-self: center; flex-grow: 1; flex-shrink: 0;">
